<template>
  ...
  >
    ...
    <div
      class="absolute inset-0 bg-opacity-50 group-hover:bg-opacity-0 transition-all duration-500 ease-in-out"
    ></div>

    <!-- Contenido Inicial: Título y Precio (visible sobre la imagen) -->
    <div
      class="absolute inset-0 p-6 flex flex-col justify-end text-white transition-opacity duration-300 ease-in-out group-hover:opacity-0 group-hover:pointer-events-none"
    >
