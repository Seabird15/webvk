    ...
    <div class="overflow-hidden relative">
      ...
      <div class="absolute z-10 inset-0 flex justify-center pt-10">
        <img
          ...
          alt=""
          class="w-2/4 lg:max-w-4/6 object-contain xl:-bottom-[15rem] xl:-right-[15rem] absolute"
        />
      </div>
    </div>
  </header>
...
.bg-banner {
  background-image: url("https://i.ibb.co/gMvkMgn9/banner-1-1746500229681-99.webp");
  height: 100vh;
  width: 100%;
}
.vignette::after {
